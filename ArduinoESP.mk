...
ifndef ESPTOOL_UPLOAD_OPTS
	ESPTOOL_UPLOAD_OPTS := -v -cd $(ESP_UPLOAD_RESETMETHOD) -cb $(ESP_UPLOAD_SPEED) -cp "$(DEVICE_PATH)" -ca 0x00000
endif

ifndef ESPTOOL_UPLOAD_FS_OPTS
	ESPTOOL_UPLOAD_FS_OPTS := -v -cd $(ESP_UPLOAD_RESETMETHOD) -cb $(ESP_UPLOAD_SPEED) -cp "$(DEVICE_PATH)" -ca 0x100000
endif
